...
import { assets } from '../assets/assets.js'; // Importing assets from the assets.js file
            ...
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>
                ...
                {/* Logo */}
                    <Link to="/" className='flex flex-row'>
                        <img src={assets.logo} alt="logo" className={`h-9 fill-white ${isScrolled && "invert opacity-80"}
                        `} />
                        <p
                            className={`px-5 font-bold text-2xl ${
                            isScrolled ? "text-black opacity-80" : "text-white"
                            }`}
                        >
                            RegalRetreat
                        </p>
                ...
                {user &&                         <UserButton>
                    ...
                    className={`${isScrolled && "invert"}h-4`}></img>
                </div>
